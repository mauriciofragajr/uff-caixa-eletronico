    ...
    <body class="text-center">
        ...
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main role="main" class="inner cover">
                <h1 class="cover-heading">Depósito</h1>
                <h5>Entre com o valor a ser depositado.</h5>
                <form method="POST" action="Operacao">
                    <div class="input-group mb-3 input-group-lg">
                        ...
                        <input name="tipo" type="hidden" value="DEPOSITO">
                    </div>
                    <button class="btn btn-lg btn-secondary" type="submit">Depositar</button>
                </form>
