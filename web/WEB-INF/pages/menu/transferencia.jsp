    ...
    <body class="text-center">
        ...
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main role="main" class="inner cover">
                <h1 class="cover-heading">Transferência</h1>

                <form method="POST" action="Operacao">
                    <h5>Entre com o valor a ser transferido.</h5>
                    <div class="input-group mb-3 input-group-lg">
                        <div class="input-group-prepend">
                            <span class="input-group-text">R$</span>
                        </div>
                        <input type="number" min="0.01" step="0.01" class="form-control" name="valor" required>
                        <input name="tipo" type="hidden" value="TRANSFERENCIA">
                    </div>
                    <h5>CPF da conta destino.</h5>
                    <div class="input-group mb-3 input-group-lg">
                        <div class="input-group-prepend">
                            <span class="input-group-text">CPF</span>
                        </div>
                        <input type="text" minlength="11" maxlength="11" class="form-control" name="cpfDestino" required>
                        <input name="tipo" type="hidden" value="TRANSFERENCIA">
                    </div>
                    <button class="btn btn-lg btn-secondary" type="submit">Transferir</button>
                </form>
            </main>
